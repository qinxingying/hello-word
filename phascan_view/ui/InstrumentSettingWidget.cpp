...
void InstrumentSettingWidget::SetWndName(setup_LANG eLang)
{
	...
	case setup_LANG_CHINESS:
        ui->LabelScanType->setText(QString::fromLocal8Bit("扫查方式:"));
        ui->LabelEncoderType->setText(QString::fromLocal8Bit("编码器:"));
        ui->LabelPrf->setText(QString::fromLocal8Bit("重复频率:"));

        ui->BoxScanArea->setTitle(QString::fromLocal8Bit("扫查区域"));
        ui->LabelPaValtage_2->setText(QString::fromLocal8Bit("扫查轴"));
        ui->LabelPaValtage_3->setText(QString::fromLocal8Bit("步进轴"));
        ui->LabelScanStart->setText(QString::fromLocal8Bit("起点:"));
        ui->LabelScanEnd->setText(QString::fromLocal8Bit("终点:"));
        ui->LabelScanResolution->setText(QString::fromLocal8Bit("分辨率:"));

        ui->BoxEncoderMode->setTitle(QString::fromLocal8Bit("编码器类型"));
        ui->LabelEncoderType_2->setText(QString::fromLocal8Bit("编码器:"));
        ui->LabelResolution->setText(QString::fromLocal8Bit("精度:"));
        ui->LabelEncoderPolarity->setText(QString::fromLocal8Bit("极性:"));
        ui->LabelEncoderDirection->setText(QString::fromLocal8Bit("类型:"));
        ui->LabelEncoderOrg->setText(QString::fromLocal8Bit("编码器起点:"));

        ui->LabelPaValtage->setText(QString::fromLocal8Bit("PA 发射电压:"));
        ui->LabelUtVolatage->setText(QString::fromLocal8Bit("UT 发射电压:"));

        ui->LabelScanPos->setText(QString::fromLocal8Bit("扫描轴当前位置:"));
        ui->LabelIndexPos->setText(QString::fromLocal8Bit("步进轴当前位置:"));
