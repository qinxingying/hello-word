...
const QMetaObject MeasureWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_MeasureWidget.data,
      qt_meta_data_MeasureWidget,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *MeasureWidget::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_MeasureWidget.stringdata0))
        return static_cast<void*>(const_cast< MeasureWidget*>(this));
