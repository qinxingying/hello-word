...
struct qt_meta_stringdata_DopplerXMLReader_t {
    QByteArrayData data[1];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DopplerXMLReader_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DopplerXMLReader_t qt_meta_stringdata_DopplerXMLReader = {
    {
QT_MOC_LITERAL(0, 0, 16) // "DopplerXMLReader"
...
const QMetaObject DopplerXMLReader::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DopplerXMLReader.data,
      qt_meta_data_DopplerXMLReader,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DopplerXMLReader::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DopplerXMLReader.stringdata0))
