...
#include "../../../doppler_view/DopplerRulerBar.h"
...
struct qt_meta_stringdata_DopplerRulerBar_t {
    QByteArrayData data[5];
    char stringdata0[49];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DopplerRulerBar_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DopplerRulerBar_t qt_meta_stringdata_DopplerRulerBar = {
    {
QT_MOC_LITERAL(0, 0, 15), // "DopplerRulerBar"
QT_MOC_LITERAL(1, 16, 16), // "signalRulerMoved"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 7), // "nStart_"
QT_MOC_LITERAL(4, 42, 6) // "nStop_"

    },
    "DopplerRulerBar\0signalRulerMoved\0\0"
    "nStart_\0nStop_"
};
...
void DopplerRulerBar::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (DopplerRulerBar::*_t)(double , double );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&DopplerRulerBar::signalRulerMoved)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject DopplerRulerBar::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DopplerRulerBar.data,
      qt_meta_data_DopplerRulerBar,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DopplerRulerBar::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DopplerRulerBar.stringdata0))
