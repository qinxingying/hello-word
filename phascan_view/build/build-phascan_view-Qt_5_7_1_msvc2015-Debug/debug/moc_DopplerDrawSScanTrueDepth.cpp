...
#include "../../../draw_scan/DopplerDrawSScanTrueDepth.h"
...
struct qt_meta_stringdata_DopplerDrawSScanTrueDepth_t {
    QByteArrayData data[1];
    char stringdata0[26];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_DopplerDrawSScanTrueDepth_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_DopplerDrawSScanTrueDepth_t qt_meta_stringdata_DopplerDrawSScanTrueDepth = {
    {
QT_MOC_LITERAL(0, 0, 25) // "DopplerDrawSScanTrueDepth"
...
const QMetaObject DopplerDrawSScanTrueDepth::staticMetaObject = {
    { &DopplerDrawScan::staticMetaObject, qt_meta_stringdata_DopplerDrawSScanTrueDepth.data,
      qt_meta_data_DopplerDrawSScanTrueDepth,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *DopplerDrawSScanTrueDepth::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_DopplerDrawSScanTrueDepth.stringdata0))
