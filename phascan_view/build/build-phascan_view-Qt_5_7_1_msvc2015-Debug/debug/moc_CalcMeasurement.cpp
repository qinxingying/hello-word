...
struct qt_meta_stringdata_CalcMeasurement_t {
    QByteArrayData data[1];
    char stringdata0[16];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_CalcMeasurement_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_CalcMeasurement_t qt_meta_stringdata_CalcMeasurement = {
    {
QT_MOC_LITERAL(0, 0, 15) // "CalcMeasurement"
...
const QMetaObject CalcMeasurement::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_CalcMeasurement.data,
      qt_meta_data_CalcMeasurement,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *CalcMeasurement::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_CalcMeasurement.stringdata0))
