...
public:
    ...
    {
        DATA_VIEW_RULER_LEFT = 0 ,//左边标尺视图
        DATA_VIEW_RULER_RIGHT ,//右边标尺视图
        DATA_VIEW_RULER_BOTTOM ,//底部标尺视图
        DATA_VIEW_RULER_MAX
    };
...
private:
    ...
    QPair<double , double>  RulerRange[4];//标尺
    QPair<double , double>  SliderRange[4];//滑块
