...
void DL_Dxf::test() {
    ...
    strcpy_s(buf1, sizeof(buf1), "  10\n");
    strcpy_s(buf2, sizeof(buf2), "10");
    strcpy_s(buf3, sizeof(buf3), "10\n");
    strcpy_s(buf4, sizeof(buf4), "  10 \n");
    strcpy_s(buf5, sizeof(buf5), "  10 \r");
    strcpy_s(buf6, sizeof(buf6), "\t10 \n");
