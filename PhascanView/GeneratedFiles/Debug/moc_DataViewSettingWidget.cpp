...
static const char qt_meta_stringdata_DataViewSettingWidget[] = {
    "DataViewSettingWidget\0\0slotButtonMinusClicked()\0"
    "slotButtonPlusClicked()\0"
    "slotSliderValueChanged(int)\0"
};
...
const QMetaObjectExtraData DataViewSettingWidget::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DataViewSettingWidget::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DataViewSettingWidget,
      qt_meta_data_DataViewSettingWidget, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DataViewSettingWidget::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DataViewSettingWidget))
