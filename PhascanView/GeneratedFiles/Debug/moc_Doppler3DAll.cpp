...
static const char qt_meta_stringdata_Doppler3DAll[] = {
    "Doppler3DAll\0\0advanceGL()\0"
};
...
void Doppler3DAll::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Doppler3DAll *_t = static_cast<Doppler3DAll *>(_o);
        switch (_id) {
        case 0: _t->advanceGL(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Doppler3DAll::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Doppler3DAll::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_Doppler3DAll,
      qt_meta_data_Doppler3DAll, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Doppler3DAll::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Doppler3DAll))
