...
static const char qt_meta_stringdata_DopplerConfigure[] = {
    "DopplerConfigure\0"
};
...
const QMetaObjectExtraData DopplerConfigure::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DopplerConfigure::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DopplerConfigure,
      qt_meta_data_DopplerConfigure, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DopplerConfigure::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DopplerConfigure))
