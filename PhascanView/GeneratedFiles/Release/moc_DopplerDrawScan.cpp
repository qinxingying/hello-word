...
static const char qt_meta_stringdata_DopplerDrawScan[] = {
    "DopplerDrawScan\0\0nType_,nStart_,nStop_\0"
    "signalScanRangeMove(int,int,int)\0"
};
...
const QMetaObjectExtraData DopplerDrawScan::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DopplerDrawScan::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_DopplerDrawScan,
      qt_meta_data_DopplerDrawScan, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DopplerDrawScan::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DopplerDrawScan))
