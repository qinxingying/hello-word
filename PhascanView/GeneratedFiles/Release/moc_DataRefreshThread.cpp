...
static const char qt_meta_stringdata_DataRefreshThread[] = {
    "DataRefreshThread\0"
};
...
const QMetaObjectExtraData DataRefreshThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject DataRefreshThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_DataRefreshThread,
      qt_meta_data_DataRefreshThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &DataRefreshThread::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DataRefreshThread))
